  ...
  const computeDeleteEmailPayload = useCallback(async (calendarItem: CalendarItem, patient: EncryptedPatient, agenda: Agenda, calendarItemType: CalendarItemType, patientEmail: string, patientPhoneNumber: string) => {
    ...
    return {
      ...
      variables: {
        ...
        service: getTranslationForEntity(agenda.properties, EntityType.SERVICE, lang) || agenda.name || '',
        procedure: getTranslationForEntity(calendarItemType.publicProperties, EntityType.CALENDARITEMTYPE, lang) || calendarItemType.name || '',
